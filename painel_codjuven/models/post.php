...
class post extends model {
    ...
    public function create($data) {
        try {
            $sql = $this->db->prepare('INSERT INTO post(id, id_categoria, id_usuario, data, genero, titulo, previo, texto, imagem, status) VALUES (:id, :id_categoria, :id_usuario, :data, :genero, :titulo, :previo, :texto, :imagem, :status)');
    ...
    public function update($data) {
        try {
            $sql = $this->db->prepare('UPDATE post SET id_categoria=:id_categoria, id_usuario=:id_usuario, data=:data, genero=:genero, titulo=:titulo, previo=:previo, texto=:texto, imagem=:imagem, status=:status WHERE id=:id');
            $sql->bindValue(':id_categoria', $data['id_categoria']);
            $sql->bindValue(':id_usuario', $data['id_usuario']);
            $sql->bindValue(':data', $data['data']);            
            $sql->bindValue(':genero', $data['genero']);
