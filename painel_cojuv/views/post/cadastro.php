                ...
                <section class="panel panel-black">
                    ...
                    <article class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9 <?php echo (isset($post_erro['titulo']['class'])) ? $post_erro['titulo']['class'] : ''; ?>">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select id="iGenero" name="nGenero" class="form-control single-select">

                                    <?php
                                    $array = array('agenda', 'feed', 'foto', 'podcast', 'video');
                                    for ($i = 0; $i < count($array); $i++) {
                                        if ($array[$i] == $post['genero']) {
                            ...
                            <div class="form-group col-md-8 <?php echo (isset($post_erro['previo']['class'])) ? $post_erro['previo']['class'] : ''; ?>">
                                ...
                                <textarea class="form-control" id="editor1" name="nDescricao" placeholder="Descrição previa (maximo 250 caracteres)" rows="8" maxlength="250"><?php echo!empty($post['previo']) ? $post['previo'] : '' ?></textarea>
                            </div>
                        </div>
                    </article>
                </section>
                    ...
                    <article class="panel-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <textarea class="form-control" name="nPost" id="iPost" rows="15"><?php echo!empty($post['texto']) ? $post['texto'] : '' ?></textarea>
                                <script>
                                    // Replace the <textarea id="editor1"> with a CKEditor 4
                                    // instance, using default configuration.
                                    CKEDITOR.replace('iPost');
                                </script>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="panel-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="tQnt_fotos" value="0" id="iQnt_fotos">
                                        <span class="btn btn-default" onclick="add_imagem();">Adicionar foto</span> <span>Quantidade de fotos atualmente: <span id="qnt_fotos"></span></span>
                                    </div>
                                    <div class="col-md-6">
